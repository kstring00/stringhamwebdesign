...
const checkins = [{ id: 'c1', project_id: PROJECT_ID, hours_mark: 10, sent_at: '2026-09-05T18:00:00Z' }];
...
http.createServer((req, res) => {
  ...
  req.on('end', () => {
    ...
    if (path === '/rest/v1/users')
      return json(res, 200, [{ id: USER_ID, email: 'client@test.dev', role: 'client', name: 'Test Client', created_at: '2026-09-01T00:00:00Z' }]);
    ...
    if (path === '/rest/v1/time_checkins') return json(res, 200, checkins);
    ...
    if (path === '/rest/v1/messages') return json(res, 200, []);
